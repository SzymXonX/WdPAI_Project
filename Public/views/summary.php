...
<head>
    ...
    <link rel="stylesheet" href="public/css/summaryStyles.css">
...
<body>
    ...
    <main class="content">
        ...
        <div class="categories-summary">
            <div class="expenses-container">
                <h2 class="section-title">wydatki według kategorii</h2>
                <ul id="expenses-list">
                    <?php foreach ($expensesSummary as $expense): ?>
                        <li>
                            <span><?= htmlspecialchars($expense['category']); ?></span>
                            <span class="summary-amount">-<?= number_format($expense['total'], 2, '.', ' ') ?> zł</span>
                        </li>
                    <?php endforeach; ?>
                </ul>
            </div>
            ...
            <div class="incomes-container">
                <h2 class="section-title">przychody według kategorii</h2>
                <ul id="incomes-list">
                    <?php foreach ($incomesSummary as $income): ?>
                        <li>
                            <span><?= htmlspecialchars($income['category']); ?></span>
                            <span class="summary-amount">+<?= number_format($income['total'], 2, '.', ' ') ?> zł</span>
                        </li>
                    <?php endforeach; ?>
                </ul>
            </div>
    ...
    <script src="public/js/summaryScript.js"></script>
</body>
</html>
